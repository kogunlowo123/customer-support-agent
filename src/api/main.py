...
app = FastAPI(
    ...
    description="AI customer support agent that handles inbound support requests, searches knowledge bases for solutions, resolves common issues autonomously, escalates complex cases, and maintains conversation context across channels.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
